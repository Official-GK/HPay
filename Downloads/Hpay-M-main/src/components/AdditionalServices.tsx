...
export const AdditionalServices: React.FC<AdditionalServicesProps> = ({
  services = [
    ...
    { id: 'statement', title: 'Statement', icon: 'https://cdn.builder.io/api/v1/image/assets/a2e53047b25843fd94cfdce41548669c/405781185ebabebf526d0d71b817ad58c290f56a?placeholderIfAbsent=true' },
    ...
    { id: 'bank-details', title: 'Bank Details', icon: 'https://cdn.builder.io/api/v1/image/assets/a2e53047b25843fd94cfdce41548669c/209695c2f0c2310951c1a09594019712cae21e28?placeholderIfAbsent=true' },
    { id: 'refund-report', title: 'Refund Report', icon: 'https://cdn.builder.io/api/v1/image/assets/a2e53047b25843fd94cfdce41548669c/a272c2fb7570b52d7ef63b8ac2e50b6bc68d5d02?placeholderIfAbsent=true' },
    ...
    { id: 'fintech-wallet', title: 'Fintech Wallet To Main Wallet', icon: 'https://cdn.builder.io/api/v1/image/assets/a2e53047b25843fd94cfdce41548669c/52be6c2ee1a6bf7613b5fdfce40bab7a977eba8c?placeholderIfAbsent=true' }
  ]
}) => {
  const handleServiceClick = (serviceId: string) => {
    // Map serviceId to GK_bro HTML file
    switch (serviceId) {
      case 'markup':
        window.location.href = '/GK_bro/markup/Markup.html';
        break;
      case 'statement':
        window.location.href = '/GK_bro/accountstatement/AccountStatement.html';
        break;
      case 'history':
        window.location.href = '/GK_bro/history/history.html';
        break;
      case 'bank-details':
        window.location.href = '/GK_bro/bankdetail/BankDetail.html';
        break;
      case 'refund-report':
        window.location.href = '/GK_bro/refundreport/RefundReport.html';
        break;
      case 'status-queue':
        window.location.href = '/GK_bro/statusqueue/StatusQueue.html';
        break;
      case 'fintech-wallet':
        window.location.href = '/GK_bro/fwtmw/FWTMW.html';
        break;
      default:
